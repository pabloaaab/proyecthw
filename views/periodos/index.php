        ...
        <tbody>
            ...
            <?php foreach ($model as $val): ?>
                ...
                <tr>                                        
                    ...
                    <td><?= $registros ?></td>                                    
                    <td><a href="<?= Url::toRoute(["periodos/generarperiodoclonar", "mesaclonar" => $val->mensualidad]) ?>" target="_blank"><img src="svg/si-glyph-plus.svg" align="center" width="20px" height="20px" title="Clonar"></a></td>
                </tr>
            </tbody>
            <?php $i = $i + 1; ?>
        <?php endforeach; ?>
