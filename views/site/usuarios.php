    ...
    <div class="table-condensed">
        <table class="table table-hover">
            ...
            <tr>
                ...
                <td><a href="<?= Url::toRoute(["site/view", "id" => $val->id]) ?>" ><img src="svg/si-glyph-document-edit.svg" align="center" width="20px" height="20px" title="Editar"></a></td>                
                <td><a href="<?= Url::toRoute(["site/editar", "id" => $val->id]) ?>"><img src="svg/si-glyph-print.svg" align="center" width="20px" height="20px" title="Imprimir"></a></td>
                <td><a href="<?= Url::toRoute(["site/cambiarclave", "id" => $val->id]) ?>"><img src="svg/si-glyph-checked.svg" align="center" width="20px" height="20px" title="Aprobar"></a></td>                
            </tr>
            </tbody>
            <?php endforeach; ?>
        </table>
