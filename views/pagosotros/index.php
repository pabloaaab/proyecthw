        ...
        <tbody>
            <?php foreach ($model as $val): ?>
                <tr>
                    ...
                    <td><a href="<?= Url::toRoute(["pagosotros/imprimir", "nropago" => $val->nropago]) ?>" target="_blank"><img src="svg/si-glyph-print.svg" align="center" width="20px" height="20px" title="Imprimir"></a></td>
                    <?php if ($val->anulado == "SI") { ?>
                        <td></td>
                    <?php } else { ?>
                        <td><a href="<?= Url::toRoute(["pagosotros/anulacion", "nropago" => $val->nropago]) ?>"><img src="svg/si-glyph-delete.svg" align="center" width="20px" height="20px" title="Anular"></a></td>
                    <?php } ?>    
                </tr>
            </tbody>
<?php endforeach; ?>
